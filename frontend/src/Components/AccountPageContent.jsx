              ...
              <form className="row g-3">
                ...
                <div className="col-md-12 mb-3">
                  <label for="diagnoses" className="form-label">
                    ...
                    <p>
                      List & detail the diagnosis and/or functional loss or
                      impairment of the child and how this is affecting the
                      family and contributing to the need for service. Mandatory
                      supporting documentation of the diagnosis and/or the
                      professional assessment must be attached to the
                      application.
                    </p>
                  </label>
                  <textarea
                ...
                <div className="col-md-12 mb-3">
                  <label for="specialInstructions" className="form-label">
                    ...
                    <p>
                      Please describe any details that will assist the provider
                      in meeting the individual needs of the client while they
                      are in our respite care. Are there any bedtime routines or
                      concerns that Rabboni Support Services should be aware of?
                      Are there any eating habits, allergies, preferences that
                      the provider should be aware of? Is there a safety plan or
                      special supervision requirement that Rabboni should be
                      aware of?
                    </p>
                  </label>
                  <textarea
                ...
                <div className="col-md-6 mb-3">
                  <label for="emergencyTransport" className="form-label">
                    In case of an emergency, can client be transported to
                    nearest hospital?
                  </label>
                  <input
                ...
                <div className="col-md-12 mb-3">
                  <label className="form-label">
                    <h3>Consent</h3>
                    <p>
                      Rabboni Support Services is committed to providing the
                      highest level of therapeutic and safe environment for your
                      client. Initialing beside each of the specialized
                      activities listed below indicates that you are permitting
                      your client to participate in such activities while in our
                      program with the understandingthat our staff will take
                      every measure possible to prevent risk of injury to your
                      client.ACTIVITIES CONSENTRespite clientmay participatein a
                      number of indoor and outdoor activities. Rabboni will
                      provide constant supervision of all clientsin the program
                      to minimize the potential for physical injuries.
                      Initiating in this area indicates that you are permitting
                      your clientto participate in general art, recreational,
                      music, physicaland educational activities while in our
                      care. __________ MEDICAL CONSENT knowingly and voluntarily
                      authorize Rabboni to administer prescribed medication to
                      client. I also authorize Rabboni to administer first aid,
                      call an Ambulance or transport client to the hospital in
                      case of an emergency. I understand that except in the case
                      of a life-threatening emergency, I will be notified in
                      advance of any medical problems requiring treatment.
                    </p>
                  </label>
                </div>
                ...
                <div className="col-md-12 mb-3">
                  <label className="form-label">
                    <h3>Signature</h3>
                    <p>
                      By typing my name below, I acknowledge that all
